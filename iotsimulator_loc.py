...
formatStr = "urn:example:sensor:loc"
...
for counter in range(0, numMsgs):
  ...
  randLat = random.uniform(-90.0, 90.0)
  randLong = random.uniform(-180.0, 180.0)
  randDepth = random.uniform(0.0, 180.0)

  if counter == numMsgs - 1:
    dataElementDelimiter = ""
  print iotmsg_data % (randLat,randLong,randDepth) + dataElementDelimiter
